...
class _LoginViewState extends State<LoginView> {
  ...
  Future<void> maybeLogin() async {
    ...
    if (success) {
      ...
      await prefs.setString('serviceKey', serviceKeyController.text);
  ...
  Future<void> maybeLoadServiceKey() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    final serviceKey = prefs.getString('serviceKey');
    if (serviceKey != null) {
      setState(() {
        serviceKeyController.text = serviceKey;
      });
      await maybeLogin();
    }
  }
